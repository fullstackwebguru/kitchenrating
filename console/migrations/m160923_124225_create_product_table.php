...
class m160923_124225_create_product_table extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable('{{%product}}', [
            ...
            'quality_level' => $this->integer(11)->notNull()->defaultValue(0),
            'price_level' => $this->integer(11)->notNull()->defaultValue(0),
            'trust_level' => $this->integer(11)->notNull()->defaultValue(0),
